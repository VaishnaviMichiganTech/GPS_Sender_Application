...
import sys
import tkFileDialog  # Change this from tkinter import
...
def generate_nmea_from_gpsfix(msg):
    utc = pytz.UTC
    # Replace datetime.now(timezone.utc) with this:
    now = datetime.utcnow()  # or datetime.now(utc)
...
if __name__ == "__main__":
    # Instead of using select_file(), directly specify the path
    bag_file = "/home/moji/gps_workspace/bags/2024-04-18-12-50-47.bag.filtered"
    gps_topic = "/gps/gps"

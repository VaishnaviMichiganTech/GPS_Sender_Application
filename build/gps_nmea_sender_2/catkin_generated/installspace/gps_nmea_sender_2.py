...
import sys
sys.path.append('/home/moji/Desktop/gps_fromrosbagonOBU/nmea-20241209T184701Z-001/nmea/ros_env/lib/python2.7/site-packages')
try:
    from Cryptodome.Random import get_random_bytes
    print("Cryptodome is installed and working.")
except ImportError as e:
    print("Error importing Cryptodome:", e)
_bytes
